...
public final class Base64 {
  ...
  /**
   * Decode the string and convert back the decoded value into a string using the specified
   * charset.
   * Use default
  ...
  /**
   * Discards any characters outside of the base64 alphabet (see page 25 of RFC 2045) "Any
