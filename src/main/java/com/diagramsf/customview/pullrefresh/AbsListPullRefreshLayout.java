...
public class AbsListPullRefreshLayout extends PullRefreshLayout {
    ...
    public AbsListPullRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    protected void contentViewScrollToPosition(boolean isRefreshToNormal,
        ...
        if (isGoodDoAbsListPadding()) {
            ...
            av.setPadding(mInitPaddingLeft, mInitPaddingTop + Math.abs(y), mInitPaddingRight, mInitPaddingBom);
