...
public abstract class MyMenuLayout extends ViewGroup {
    ...
    private final float BLUR_ALPHA = 0.6f;// 遮罩View最终的透明度
                ...
                if (0 == i) { // blur View
                    ...
                    switch (mItemLocation) {
                        ...
                        case Top:
                            ...
                            break;
                        case Bom:
                            childView.layout(l, b - childHeight, l
                                    + childWidth, b);
                            break;
                    }
    ...
    protected void onDetachedFromWindow() {
        ...
        if (null != mHideMenuAnimatorSet) {
            if (mHideMenuAnimatorSet.isRunning()) {
                mHideMenuAnimatorSet.cancel();
            }
        }

        if (null != mShowMenuAnimatorSet) {
            if (mShowMenuAnimatorSet.isRunning()) {
    ...
    private void addMenuAndBlurView() {
        ...
        final LayoutParams blurParams = new LayoutParams(
                LayoutParams.MATCH_PARENT,
                LayoutParams.MATCH_PARENT);
        final LayoutParams itemParams = new LayoutParams(
                LayoutParams.MATCH_PARENT,
        ...
        if (!animat) {
            ...
            switch (mItemLocation) {
                case Top:
                    ...
                    ObjectAnimator topItemShow = ObjectAnimator.ofFloat(itemView,
                            "translationY", 0f, -itemViewHeight);
                    ObjectAnimator topBlurShow = ObjectAnimator.ofFloat(blurView,
                            "alpha", BLUR_ALPHA, 0f);
                ...
                case Bom:
                    ...
                    ObjectAnimator bomItemHide = ObjectAnimator.ofFloat(itemView,
                            "translationY", 0f, itemViewHeight);
                    ObjectAnimator bomBlurHide = ObjectAnimator.ofFloat(blurView,
                            "alpha", BLUR_ALPHA, 0f);
            ...
            if (!mIsAnimateItem) {
                ...
                switch (mItemLocation) {
                    case Top:
                        ...
                        ObjectAnimator topItemShow = ObjectAnimator.ofFloat(
                                itemView, "translationY", -itemViewHeight, 0f);
                        ObjectAnimator topBlurShow = ObjectAnimator.ofFloat(
                                blurView, "alpha", 0f, BLUR_ALPHA);
                        ...
                        break;
                    case Bom:
                        ObjectAnimator bomItemShow = ObjectAnimator.ofFloat(
                                itemView, "translationY", itemViewHeight, 0f);
                        ObjectAnimator bomBlurShow = ObjectAnimator.ofFloat(
                                blurView, "alpha", 0f, BLUR_ALPHA);
    ...
    public final View createDefaultBlurView() {
        ...
        blur.setLayoutParams(new ViewGroup.LayoutParams(
