...
public final class Base64 {
    ...
    final public static String encodeToString(byte[] data) {
        if (null == data) {
            return null;
        }
    ...
    final public static String encodeToString(String data) {
        if (null == data) {
            return null;
        }
     ...
     */
    final public static String decode(String data, String charset) {
        if (null == data) {
            return null;
        }
        if (charset == null) {
     ...
     * encoding if charset is null or invalid.
     */
    final public static String decode(byte[] data, String charset) {
        if (null == data) {
            return null;
        }
        if (charset == null) {
