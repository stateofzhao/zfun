...
public class DeviceHelper {
    ...
    public static boolean isNetworkAvailable(Context context) {
        ConnectivityManager connectivityManager
                = AndroidHelper.getService(context, Context.CONNECTIVITY_SERVICE);
    ...
    public static boolean isWifiEnable(Context context) {
        WifiManager wifiManager = AndroidHelper.getService(context, Context.WIFI_SERVICE);
     ...
     * 摘自<a href="http://stackoverflow.com/questions/6064510/how-to-get-ip-address-of-the-device#answers">stack overflow</a>
     *
     ...
     * <a href="http://stackoverflow.com/questions/1957637/java-convert-int-to-inetaddress#answer-1957670">stack overflow</a>
     * <p/>
     * 摘自
     * <a href="http://stackoverflow.com/questions/16730711/get-my-wifi-ip-address-android#answer-18638588">stack overflow</a>
     *
    ...
    public static String getIMSI(Context context) {
        TelephonyManager telemamanger = AndroidHelper.getService(context, Context.TELEPHONY_SERVICE);
