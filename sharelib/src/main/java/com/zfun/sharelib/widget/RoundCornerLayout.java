...
public class RoundCornerLayout extends FrameLayout {
    ...
    public RoundCornerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (attrs != null) {
            TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerLayout);
            float radius = ta.getDimension(R.styleable.RoundCornerLayout_round_layout_radius, 0);
            topLeftRadius = ta.getDimension(R.styleable.RoundCornerLayout_round_top_left, radius);
            topRightRadius = ta.getDimension(R.styleable.RoundCornerLayout_round_top_right, radius);
            bottomLeftRadius = ta.getDimension(R.styleable.RoundCornerLayout_round_bottom_left, radius);
            bottomRightRadius = ta.getDimension(R.styleable.RoundCornerLayout_round_bottom_right, radius);
            ta.recycle();
        }
